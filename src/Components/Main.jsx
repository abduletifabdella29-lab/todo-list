        ...
        <div className='w-full flex justify-center h-9.5 mt-4'>
            <div className='relative flex items-center'>
                <input 
                    ...
                    className={`sm:w-120.75 lg:w-148.75 h-9.5 pl-3 pr-10 border-[1.4px] border-[#6C63FF] rounded-lg outline-none text-sm ${ darkMode
            ...
            <div className='relative ml-5'>
                <button className="bg-[#6C63FF] lg:w-21.25 h-9.5 w-17 rounded-lg flex items-center gap-2 lg:gap-4 px-3 hover:bg-[#574DDB] transition-colors duration-200">
                    <h1 className="text-white font-semibold text-[18px]">ALL</h1>
